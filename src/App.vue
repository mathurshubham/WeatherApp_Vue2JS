...
export default {
  ...
  data (){
    return{
      ...
      api_key: '484f03edd81617526f31cae138cc9528',
...
//https://api.openweathermap.org/data/2.5/weather?q=delhi&units=metric&APID=484f03edd81617526f31cae138cc9528
  methods:{
    fetchWeather(e){
      if(e.key == "Enter"){
...
#app.warm{
  background-image: url('./assets/hot-summer.jpg')
}
